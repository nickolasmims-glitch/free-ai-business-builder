...
let state={jobs:[],events:[],signals:{},workers:{ai1:{runs:0,lastRun:null,lastError:null},ai2:{runs:0,lastRun:null,lastError:null},ai3:{runs:0,lastRun:null,lastError:null}}};let loaded=false;
