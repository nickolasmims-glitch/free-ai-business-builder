(() => {
  const mount = () => {
      ...
      <div class="obc-shell">
        ...
        <div class="obc-sections">
          ...
          <div class="obc-panel" style="grid-column:1/-1">
            ...
            <div class="lc-grid">
              <div class="lc-card"><h4>Texas Pick 3</h4><p>3 digits, 0–9. Paste recent draws.</p><div class="lc-odds">Exact 3-digit outcome: <b>0.100000%</b> (1 in 1,000)</div><div id="lc-p3-score" class="lc-score">Research signal: — / 10</div><textarea id="lc-p3" placeholder="526,166,504,127"></textarea><button class="obc-btn" data-game="p3">Analyze</button><div class="lc-result" id="lc-p3-result"></div></div>
    ...
    const setScore=(id,score)=>{const e=document.getElementById(id+"-score");if(e)e.innerHTML='Research signal: <b>'+score+'/10</b><div class="lc-scorebar"><div class="lc-scorefill" style="width:'+(score*10)+'%"></div></div><div class="obc-note">Historical-analysis score only; it does not change the game odds.</div>'};
