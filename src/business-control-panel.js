      ...
      <div class="obc-shell">
        ...
        <div class="obc-sections">
          ...
          <div class="obc-panel" style="grid-column:1/-1">
            ...
            <div class="lc-grid">
              <div class="lc-card"><h4>Texas Pick 3</h4><p>3 digits, 0–9. Paste recent draws.</p><div class="lc-odds">Exact 3-digit outcome: <b>0.100000%</b> (1 in 1,000)</div><textarea id="lc-p3" placeholder="526,166,504,127"></textarea><button class="obc-btn" data-game="p3">Analyze</button><div class="lc-result" id="lc-p3-result"></div></div>
              ...
              <div class="lc-card"><h4>Powerball</h4><p>5 white balls 1–69 + Powerball 1–26.</p><div class="lc-odds">Jackpot chance per exact line: <b>0.000000342%</b> (1 in 292,201,338)</div><textarea id="lc-pb" placeholder="Example: 2 7 9 17 58 + 20"></textarea><button class="obc-btn" data-game="pb">Analyze</button><div class="lc-result" id="lc-pb-result"></div></div>
              <div class="lc-card"><h4>Mega Millions</h4><p>5 white balls 1–70 + Mega Ball 1–24.</p><div class="lc-odds">Jackpot chance per exact line: <b>0.000000344%</b> (1 in 290,472,336)</div><textarea id="lc-mm" placeholder="Example: 10 20 30 40 50 + 12"></textarea><button class="obc-btn" data-game="mm">Analyze</button><div class="lc-result" id="lc-mm-result"></div></div>
            </div>
            <div class="obc-note">The percentage shown on each game is the mathematical chance for the specified outcome and does not change day-to-day. The blinking STATISTICAL SIGNAL is a separate historical-frequency indicator and is not an increased winning probability.</div>
          </div>
        </div>
      </div>`;
